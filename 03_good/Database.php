...
class Database
{
    ...
    public function getProducts($search = ''){
        ...
        if ($search){
            ...
            $statement = $this->pdo -> prepare('SELECT * FROM products ORDER BY create_date DESC');  // exec is anotther option, but it is recommended in making some changes in the databases kema.
        }
        $statement -> execute();
